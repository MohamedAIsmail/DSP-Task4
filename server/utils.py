...
class Image:
    ...
    def fourierEllpiseMasker(self, x0, y0, Rx, Ry, img_type):
...
class combine_img:
    ...
    def finalImageFormation(imgObject1, imgObject2):
        ...
        OutputImage = np.multiply(
            imgObject1.magntiude, np.exp(1j * imgObject2.phase))
    ...
    def controller(imageObject, brightness=400, contrast=150):
        ...
        if brightness != 0:
            ...
            # The function add Weighted calculates the weighted sum of two arrays
